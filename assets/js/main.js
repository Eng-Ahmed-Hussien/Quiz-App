      ...
      const progressLoadElement = document.querySelector("#progress");
        ...
        try {
          ...
          submitButton.onclick = () => {
            if (currentQuestionIndex < totalQuestions) {
              ...
              if (
                checkedInput &&
                checkedInput.dataset.choice === correctAnswer
              ) {
                result += 10;
              }
              ...
              progressLoadElement.style.width =
                parseFloat(progressLoadElement.style.width || "0") +
                loadWidth +
                "%";
